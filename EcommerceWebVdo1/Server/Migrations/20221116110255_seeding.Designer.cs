...
namespace EcommerceWebVdo1.Server.Migrations
{
    ...
    [Migration("20221116110255_seeding")]
            ...
            modelBuilder.Entity("EcommerceWebVdo1.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 11, 16, 16, 32, 54, 998, DateTimeKind.Local).AddTicks(1433),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 11, 16, 16, 32, 54, 998, DateTimeKind.Local).AddTicks(1480),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "It is a PC game. Developed by Ubisoft",
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 11, 16, 16, 32, 54, 998, DateTimeKind.Local).AddTicks(1486),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 11, 16, 16, 32, 54, 998, DateTimeKind.Local).AddTicks(1490),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 2,
                            DateCreated = new DateTime(2022, 11, 16, 16, 32, 54, 998, DateTimeKind.Local).AddTicks(1493),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 2,
                            DateCreated = new DateTime(2022, 11, 16, 16, 32, 54, 998, DateTimeKind.Local).AddTicks(1496),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 7,
                            CategoryId = 3,
                            DateCreated = new DateTime(2022, 11, 16, 16, 32, 54, 998, DateTimeKind.Local).AddTicks(1499),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 8,
                            CategoryId = 3,
                            DateCreated = new DateTime(2022, 11, 16, 16, 32, 54, 998, DateTimeKind.Local).AddTicks(1502),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
