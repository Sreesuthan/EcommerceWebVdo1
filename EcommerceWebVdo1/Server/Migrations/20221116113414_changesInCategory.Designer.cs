...
namespace EcommerceWebVdo1.Server.Migrations
{
    ...
    [Migration("20221116113414_changesInCategory")]
            ...
            modelBuilder.Entity("EcommerceWebVdo1.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 11, 16, 17, 4, 14, 16, DateTimeKind.Local).AddTicks(2999),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 11, 16, 17, 4, 14, 16, DateTimeKind.Local).AddTicks(3018),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "It is a PC game. Developed by Ubisoft",
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 11, 16, 17, 4, 14, 16, DateTimeKind.Local).AddTicks(3020),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 11, 16, 17, 4, 14, 16, DateTimeKind.Local).AddTicks(3022),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 2,
                            DateCreated = new DateTime(2022, 11, 16, 17, 4, 14, 16, DateTimeKind.Local).AddTicks(3024),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 2,
                            DateCreated = new DateTime(2022, 11, 16, 17, 4, 14, 16, DateTimeKind.Local).AddTicks(3026),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 7,
                            CategoryId = 3,
                            DateCreated = new DateTime(2022, 11, 16, 17, 4, 14, 16, DateTimeKind.Local).AddTicks(3029),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 8,
                            CategoryId = 3,
                            DateCreated = new DateTime(2022, 11, 16, 17, 4, 14, 16, DateTimeKind.Local).AddTicks(3032),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
